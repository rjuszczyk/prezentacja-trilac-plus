...
import pl.pharmaway.prezentacjatrilacplus.mvp.LoadingModel;
import pl.pharmaway.prezentacjatrilacplus.network.DataVersion;
import pl.pharmaway.prezentacjatrilacplus.network.GetDataResponse;
...
public class LoadingModelImpl implements LoadingModel {
    ...
    @Override
    public Cancelable checkUpdate(final LoadingModel.CheckUpdateCallback checkUpdateCallback) {
